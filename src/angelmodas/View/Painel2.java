...
public class Painel2 extends javax.swing.JPanel {
    ...
    public void atualizarValores(float investimento, float faturamentoReal, float lucroReal) {
        jLabel4.setText(String.valueOf(investimento));
        jLabel5.setText(String.valueOf(faturamentoReal));
        jLabel6.setText(String.valueOf(lucroReal));
    }
    
    public void atualizarData(String dataFormatada) {
        jLabel7.setText(dataFormatada);
    }
    
    public void atualizarHoraAtual(String time) {
    ...
    public void botarLabels() {
        ...
        iconInvestimento.setIcon(new javax.swing.ImageIcon(getClass().getResource("/angelmodas/imagens/seta-cima.png")));
        ...
        iconFaturamento.setIcon(new javax.swing.ImageIcon(getClass().getResource("/angelmodas/imagens/seta-baixo.png")));
